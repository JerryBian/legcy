;(function (global, factory) {
    ...
    function be__relativeTimeWithPlural(number, withoutSuffix, key) {
        var format = {
            'mm': withoutSuffix ? 'хв?л?на_хв?л?ны_хв?л?н' : 'хв?л?ну_хв?л?ны_хв?л?н',
            'hh': withoutSuffix ? 'гадз?на_гадз?ны_гадз?н' : 'гадз?ну_гадз?ны_гадз?н',
            'dd': 'дзень_дн?_дзён',
            'MM': 'месяц_месяцы_месяца?',
            'yy': 'год_гады_гадо?'
        };
        if (key === 'm') {
            return withoutSuffix ? 'хв?л?на' : 'хв?л?ну';
        }
        else if (key === 'h') {
            return withoutSuffix ? 'гадз?на' : 'гадз?ну';
        }
        else {
    ...
    var be = moment__default.defineLocale('be', {
        months : {
            format: 'студзеня_лютага_сакав?ка_красав?ка_тра?ня_чэрвеня_л?пеня_жн??ня_верасня_кастрычн?ка_л?стапада_снежня'.split('_'),
            standalone: 'студзень_люты_сакав?к_красав?к_травень_чэрвень_л?пень_жн?вень_верасень_кастрычн?к_л?стапад_снежань'.split('_')
        },
        monthsShort : 'студ_лют_сак_крас_трав_чэрв_л?п_жн?в_вер_каст_л?ст_снеж'.split('_'),
        weekdays : {
            format: 'нядзелю_панядзелак_а?торак_сераду_чацвер_пятн?цу_суботу'.split('_'),
            standalone: 'нядзеля_панядзелак_а?торак_серада_чацвер_пятн?ца_субота'.split('_'),
            isFormat: /\[ ?[Вв] ?(?:м?нулую|наступную)? ?\] ?dddd/
        },
        ...
        calendar : {
            ...
            lastWeek: function () {
                ...
                case 5:
                case 6:
                    return '[У м?нулую] dddd [?] LT';
                case 1:
                case 2:
                case 4:
                    return '[У м?нулы] dddd [?] LT';
                }
            },
            sameElse: 'L'
        },
        ...
        meridiemParse: /ночы|ран?цы|дня|вечара/,
        isPM : function (input) {
        ...
        ordinal: function (number, period) {
            ...
            case 'w':
            case 'W':
                return (number % 10 === 2 || number % 10 === 3) && (number % 100 !== 12 && number % 100 !== 13) ? number + '-?' : number + '-ы';
            case 'D':
                return number + '-га';
            default:
                return number;
    ...
    var cs__months = 'leden_únor_b?ezen_duben_květen_?erven_?ervenec_srpen_zá?í_?íjen_listopad_prosinec'.split('_'),
        cs__monthsShort = 'led_úno_b?e_dub_kvě_?vn_?vc_srp_zá?_?íj_lis_pro'.split('_');
    ...
    function cs__translate(number, withoutSuffix, key, isFuture) {
        ...
        case 'MM': // 9 months / in 9 months / 9 months ago
            if (withoutSuffix || isFuture) {
                return result + (cs__plural(number) ? 'měsíce' : 'měsíc?');
            } else {
    ...
    var el = moment__default.defineLocale('el', {
        ...
        calendar : function (key, mom) {
            ...
            return output.replace('{}', (hours % 12 === 1 ? 'στη' : 'στι?'));
        },
        relativeTime : {
            future : 'σε %s',
            past : '%s πριν',
    ...
    var gl = moment__default.defineLocale('gl', {
        ...
        calendar : {
            ...
            nextDay : function () {
                return '[ma?á ' + ((this.hours() !== 1) ? 'ás' : 'á') + '] LT';
            },
            nextWeek : function () {
    ...
    var weekEndings = 'vasárnap hétf?n kedden szerdán csüt?rt?k?n pénteken szombaton'.split(' ');
    ...
    function is__translate(number, withoutSuffix, key, isFuture) {
        ...
        case 'M':
            ...
            return isFuture ? 'mánue' : 'mánuei';
        case 'MM':
            if (is__plural(number)) {
                if (withoutSuffix) {
                    return result + 'mánueir';
                }
                return result + (isFuture ? 'mánuei' : 'mánueum');
            } else if (withoutSuffix) {
                return result + 'mánueur';
            }
            return result + (isFuture ? 'mánue' : 'mánuei');
        case 'y':
    ...
    var kk = moment__default.defineLocale('kk', {
        months : '?а?тар_А?пан_Наурыз_С?у?р_Мамыр_Маусым_Ш?лде_Тамыз_?ырк?йек_?азан_?араша_Желто?сан'.split('_'),
        monthsShort : '?а?_А?п_Нау_С?у_Мам_Мау_Ш?л_Там_?ыр_?аз_?ар_Жел'.split('_'),
        weekdays : 'Жексенб?_Д?йсенб?_Сейсенб?_С?рсенб?_Бейсенб?_Ж?ма_Сенб?'.split('_'),
    ...
    var lt = moment__default.defineLocale('lt', {
        months : {
            format: 'sausio_vasario_kovo_baland?io_gegu??s_bir?elio_liepos_rugpjū?io_rugs?jo_spalio_lapkri?io_gruod?io'.split('_'),
            standalone: 'sausis_vasaris_kovas_balandis_gegu??_bir?elis_liepa_rugpjūtis_rugs?jis_spalis_lapkritis_gruodis'.split('_')
        },
    ...
    var lv__units = {
        ...
        'M': 'mēne?a_mēne?iem_mēnesis_mēne?i'.split('_'),
        'MM': 'mēne?a_mēne?iem_mēnesis_mēne?i'.split('_'),
    ...
    function relativeSeconds(number, withoutSuffix) {
        return withoutSuffix ? 'da?as sekundes' : 'da?ām sekundēm';
    }
    ...
    var monthsNominative = 'styczeń_luty_marzec_kwiecień_maj_czerwiec_lipiec_sierpień_wrzesień_pa?dziernik_listopad_grudzień'.split('_'),
    ...
    var tzl = moment__default.defineLocale('tzl', {
        months : 'Januar_Fevraglh_Mar?_Avr?u_Mai_Gün_Julia_Guscht_Setemvar_Listop?ts_Noemvar_Zecemvar'.split('_'),
        monthsShort : 'Jan_Fev_Mar_Avr_Mai_Gün_Jul_Gus_Set_Lis_Noe_Zec'.split('_'),
        weekdays : 'Súladi_Lúne?i_Maitzi_Márcuri_Xhúadi_Viéner?i_Sáturi'.split('_'),
    ...
    function weekdaysCaseReplace(m, format) {
        ...
        nounCase = (/(\[[ВвУу]\]) ?dddd/).test(format) ?
            'accusative' :
            ((/\[?(?:минуло?|наступно?)? ?\] ?dddd/).test(format) ?
                'genitive' :
                'nominative');
    ...
    var uk = moment__default.defineLocale('uk', {
        months : {
            'format': 'с?чня_лютого_березня_кв?тня_травня_червня_липня_серпня_вересня_жовтня_листопада_грудня'.split('_'),
            'standalone': 'с?чень_лютий_березень_кв?тень_травень_червень_липень_серпень_вересень_жовтень_листопад_грудень'.split('_')
        },
        ...
        calendar : {
            sameDay: processHoursFunction('[Сьогодн? '),
            ...
            lastWeek: function () {
                ...
                case 5:
                case 6:
                    return processHoursFunction('[Минуло?] dddd [').call(this);
                case 1:
                case 2:
                case 4:
        ...
        meridiemParse: /ноч?|ранку|дня|вечора/,
        isPM: function (input) {
