...
namespace Laobian.Common.Azure
{
    ...
    public interface IAzureBlobClient
    {
        ...
        Task<string> UploadAsync<T>(BlobContainer container, string blobName, BlobType blobType, T obj);
        ...
        Task<T> DownloadAsync<T>(BlobContainer container, string blobName, BlobType blobType);
